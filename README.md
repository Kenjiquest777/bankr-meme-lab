...
## Meme Categories
- **Beef & FUD** — Dwight Schrute, Disaster Girl, Kermit, Mocking SpongeBob, Woman Yelling at Cat, Change My Mind, Conspiracy Meme.
- **Self-Grill & Cope** — Wojak Feels, Crying Wojak, This Is Fine, Midwit, Hide the Pain Harold.
- **Trench Life & Dev Pain** — Drake, Gru's Plan, Stonks.
- **Just Make Things & 0xDeployer** — Drake, Change My Mind, Morpheus, Roll Safe, Galaxy Brain, Doge, Success Kid, Leo Cheers, Yo Dawg, Always Has Been.
- **Base & Bankr Bish** — Change My Mind, Always Has Been, Oprah, Success Kid, Morpheus, Joker, Bankr Bot.
- **Agent Life & Lore** — Drake, Distracted Boyfriend, Buzz Lightyear, Doge, Morpheus, Philosoraptor, Oprah, Yo Dawg, Leo Cheers, Success Kid, Always Has Been, Change My Mind.
...
- **Star Wars Anakin**: 3-panel series with comment slots at the top left (Anakin), top right (Padme), and bottom right (Padme).
- **Bernie Sanders Support**: Single-line auto-scaling comment slot directly underneath "I am once again asking for your support".
- **Conspiracy Meme**: Top and bottom text sections mapped to memegen native engine.
- **Gary Gensler**: Comment section at the bottom.
- **Two Buttons Meme**: Strategic comment slots above the left button, above the right button, and on the bottom sweating guy panel.
- **Dwight Schrute**: Restored in Beef & FUD category with custom question and statement slots.
- **Soy Boy vs Yes Chad**: Top comment (Soy Boy side) and bottom comment (Yes Chad side).
- **Is This A Pigeon?**: Auto-scaling object label and guy/question slots.

## Running Locally
Simply open `index.html` in any web browser. No build steps or external dependencies required.
